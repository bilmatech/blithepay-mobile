...
class ShimmerTableLoader extends StatelessWidget {
  ...
  const ShimmerTableLoader({super.key, this.rowCount = 5});
    ...
    return Shimmer.fromColors(
      ...
      child: SingleChildScrollView(
        ...
        child: DataTable(
          columns: [
            DataColumn(
              label: Container(height: 16, width: 60, color: Colors.white),
            ),
            DataColumn(
              label: Container(height: 16, width: 80, color: Colors.white),
            ),
            DataColumn(
              label: Container(height: 16, width: 70, color: Colors.white),
            ),
            DataColumn(
              label: Container(height: 16, width: 60, color: Colors.white),
            ),
