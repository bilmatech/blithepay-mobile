      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Text(AppStrings.transferAccountDetails, style: AppTextStyles.bodyLarge),
              const SizedBox(height: 8),
              const Text(AppStrings.fundyouBilthePay, style: AppTextStyles.bodyRegular),
              ...
              // Info Box
              const InfoBoxWidget(
                message: "Transfer to this account and your wallet will be credited instantly",
              ),
